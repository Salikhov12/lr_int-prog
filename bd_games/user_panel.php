...
<?php
$result=mysqli_query($link,"SELECT * FROM users where id='".$_SESSION['userid']."'"); // запрос на выборку сведений о пользователях
$a=1;
...
. "'>Редактировать</a></td>"; // запуск скрипта для редактирования
 //echo "<td><a href='delete.php?id=" . $row['id']. "&table=users'>Удалить</a></td>"; // запуск скрипта для удаления записи
 echo "</tr>";
 $a++;
}
print "</table>";
